...
public class ShopingCartPage {
	/*
	 * Initialize Web Elements of the ShopingCartPage Using PageFactory.
	 */
	...
	private WebElement shopingCartDisplay;
	
	public WebElement getShopingCartDisplay() {
		return shopingCartDisplay;
	}
